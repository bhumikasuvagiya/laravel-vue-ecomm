@extends('layout.app')
@section('title','KgKrunch - Sub Category List') 
@section('content') 
<div class="wrapper">
    <div class="main">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="toast-header mt-2 mb-2">
                                <h5 class="header-title">Subcategory</h5>
                            </div>
                            <div class="card-body">
                            ...
                            @endif                             
                            <form id="subcategory_list_form" class="kg-table-card" method="post" action="{{ route('del_subcategory')}}" onSubmit="return giveNotation();">
                                @csrf
                                <div class="mb-3">
                                    <a href="{{ route('new-subcategory') }}" class="btn btn-success">Add</a>
...
<script>
	$(document).ready(function(e) {
        master = $('#tbl_user_list').DataTable({
            ...
            autoWidth: true,
            pageLength: 10,
            sAjaxSource: "{{ route('ajax_get_subcategory_list') }}",
            language: {
                search: "",
            ...
            aoColumns: [{
                    ...
                    mRender: function(v, t, o) {
                        var id = o['subcategory_id'];
                        var act_html = '-';

                        act_html = '<div class="flat-grey single-row">	<input type="checkbox" name="subcategories[]" class="all_del" value="' + id +'">	</div>'
                ...
                },
                {
                    ...
                    mRender: function(v, t, o) {
                        ...
                        var act_html = '-';
                        // console.log(id);
                        var edit_path = "{{ route('update_subcategory', ':id') }}";
                        ...
                        delete_btn = '<a href="javascript:void(0);" class="btn btn-danger width-sm waves-effect waves-light" title="Delete" onClick="return del_subcategory('+ id +')"><i class="fas fa-trash-alt"></i> Delete </a>';
...
<script type="text/javascript">
	...
	function del_subcategory(subcategory_id) {        
		if (confirm("Are You Sure?")) {
			$.ajax({
				url: "del_single_subcategory/" + subcategory_id,
				success: function(msg) {
					master.row($('#row_').subcategory_id).remove().draw(false);
					
					$('#success_msg_action').html('Subcategory Delete successfully.');
